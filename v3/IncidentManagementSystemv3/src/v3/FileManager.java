...
public class FileManager {
    ...
    public static void parseIncident(String incidentStr, String userId, Map<String, List<Incident>> userIncidents) {
        try {
            ...
            for (String line : lines) {
                if (line.startsWith("v3.Incident ID:")) {
                    id = line.substring("v3.Incident ID:".length()).trim();
