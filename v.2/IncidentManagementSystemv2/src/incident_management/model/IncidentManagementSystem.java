...
public class IncidentManagementSystem {
    ...
    private void showMainMenu() {
        ...
        System.out.println("3. Edit Incident");
    ...
    public void run() {
        ...
        while (!exit) {
            showMainMenu();
            int choice = InputUtility.getValidIntegerInput(1, 5);
        ...
        System.out.println("Thank you for using the Incident Management System!");
    }
}